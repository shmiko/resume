    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            custom: {
                ...
                dest: 'app/dist/resume.js'
            },
            css: {
                src: ['app/css/*.css'],
                dest: 'app/css/resume.css'
            }
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'app/dist/allcss.min.css': ['app/css/resume.css']
                }
            }
        },
        jshint: {
        ...
        ngAnnotate: {
            ...
            app: {
                files: {
                    'app/dist/a-lucas.resume-annotate.js': ['app/dist/resume.js'],
                }
            }
        },
        uglify: {
            app: {
                files: {
                    'app/dist/a-lucas.resume.min.js': ['app/dist/resume-annotate.js']
                }
            }
        },
        exec: {
