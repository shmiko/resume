...
// Declare app level module which depends on views, and components
    angular.module('Paul_R Jones_CV', [
        'ngRoute',
        'Paul_R Jones_CV.pro',
        'Paul_R Jones_CV.education',
        'Paul_R Jones_CV.portfolio',
        'Paul_R Jones_CV.service',
        'Paul_R Jones_CV.skills',
        'Paul_R Jones_CV.contact',
        'Paul_R Jones_CV.technologies',
        'Paul_R Jones_CV.menu',
        'ngMaterial',
        'ngAnimate',
        'angularSlideables',
        'unsafeHtml',
        ...
        'templates-main'
            ...
            .config(['$routeProvider', function ($routeProvider) {
                    $routeProvider.when('/PaulRJones', {
                        templateUrl: 'views/menu.html',
                        controller: 'AppCtrl'
                    }).otherwise({redirectTo: '/PaulRJones'});
                }])
...
(function () {
    ...
    var myModule = angular.module('Paul_R Jones_CV.services', []).service('DataSource', function ($http) {
    ...
    angular.module('Paul_R Jones_CV.education', ['Paul_R Jones_CV.services'])
    ...
    'use strict';
    angular.module('Paul_R Jones_CV.portfolio', ['Paul_R Jones_CV.services'])
    ...
    'use strict';
    angular.module('Paul_R Jones_CV.pro', ['Paul_R Jones_CV.services'])
    ...
    'use strict';
    angular.module('Paul_R Jones_CV.service', ['Paul_R Jones_CV.services'])
    ...
    'use strict';
    angular.module('Paul_R Jones_CV.skills', ['Paul_R Jones_CV.services'])
        ...
        ;(function () {
    'use strict';
    angular.module('Paul_R Jones_CV.contact', ['Paul_R Jones_CV.services', 'ngMaterial', 'ngMessages'])
...
;(function () {
    ...
    angular.module('Paul_R Jones_CV.menu', [])
       ...
       ;(function () {
    'use strict';
    angular.module('Paul_R Jones_CV.technologies', ['Paul_R Jones_CV.services'])
